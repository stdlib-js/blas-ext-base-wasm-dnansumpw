...
/**
* Interface describing a `dnansumpw` WebAssembly module.
*/
...
/**
* Interface describing `dnansumpw`.
*/
interface Routine extends ModuleWrapper {
	...
	*
	* var out = dnansumpw.ndarray( 4, x, 2, 1 );
	* // returns 5.0
	*/
