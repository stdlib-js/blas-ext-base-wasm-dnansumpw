...
var O=require('@stdlib/assert-is-wasm-memory/dist'),y=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),S=require('@stdlib/utils-inherit/dist'),q=require('@stdlib/wasm-module-wrapper/dist'),g=require('@stdlib/error-tools-fmtprodmsg/dist'),j=c();function n(e){if(!(this instanceof n))return new n(e);if(!O(e))throw new TypeError(g('29nH0',e));return q.call(this,j,e,{env:{memory:e}}),this}S(n,q);y(n.prototype,"main",function(r,i,t){return this._instance.exports.stdlib_strided_dnansumpw(r,i,t)});y(n.prototype,"ndarray",function(r,i,t,o){return this._instance.exports.stdlib_strided_dnansumpw_ndarray(r,i,t,o)});m.exports=n
